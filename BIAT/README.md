...
$ npm install
# watches your files and uses livereload by default run `npm start` for a dev server. Navigate to `http://192.168.1.3:4200/`. The app will automatically reload if you change any of the source files.
$ npm start
